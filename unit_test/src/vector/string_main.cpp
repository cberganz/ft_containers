...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/30 16:10:52 by cberganz          #+#    #+#             */
/*   Updated: 2022/07/30 17:06:04 by cberganz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	//	std::cout << BOB[i] << ' ';
	//std::cout << '\n';
	vector<std::string> MIKE(9); // BOB au lieu de 5
	...
	*/
	...
	//	insert_in_me.push_back(ft::toStr(i) + " I love hbaudet\n");
...
////	*const_it = 89; // Does not compile because it's a const_iterator
	...
	//for (size_t i = 0; i < 15; i++)
	//	std_insert_in_me.push_back(ft::toStr(i) + " 42 ");
	...
	//	insert_bis.push_back(ft::toStr(3 * i));
	...
	//for (size_t i = 0; i < 15; i++)
	//	erase_in_me.push_back(ft::toStr(2 * i));
